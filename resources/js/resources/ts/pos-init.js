...
const NSPosShippingPopup = window.NsLayawayPopup = require('./popups/ns-pos-' + 'shipping' + '-popup').default;
export class POS {
    constructor() {
    ...
    computeProductsTaxes(order) {
         ...
         * and sum the total.
         */
        const totalTaxes = products.map((product) => {
    ...
    printOrder(order_id) {
        ...
        switch (options.ns_pos_printing_gateway) {
            case 'default':
                this.processRegularPrinting(order_id);
                break;
            default:
                this.processCustomPrinting(order_id, options.ns_pos_printing_gateway);
                break;
        }
    }
