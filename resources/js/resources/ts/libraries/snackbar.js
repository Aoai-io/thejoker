...
export class SnackBar {
    ...
    error(message, label = null, options = { duration: 3000, type: 'error' }) {
        return this.show(message, label, Object.assign(Object.assign({}, options), { type: 'error' }));
    }
    success(message, label = null, options = { duration: 3000, type: 'success' }) {
        return this.show(message, label, Object.assign(Object.assign({}, options), { type: 'success' }));
    }
    info(message, label = null, options = { duration: 3000, type: 'info' }) {
        return this.show(message, label, Object.assign(Object.assign({}, options), { type: 'info' }));
    }
    /**
     *
