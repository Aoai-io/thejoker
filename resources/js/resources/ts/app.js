...
const components = Object.assign(Object.assign({ NsModules,
    NsRewardsSystem,
    NsCreateCoupons,
    NsManageProducts,
    NsSettings,
    ...
    NsPOSLoadingPopup,
    NsOrderInvoice,
    VueApexCharts }, baseComponents), nsExtraComponents);
...
window['nsDashboardAside'] = nsDashboardAside;
window['nsDashboardOverlay'] = new Vue({
...
window['nsDashboardHeader'] = new Vue({
    el: '#dashboard-header',
    data: {
        menuToggled: false,
        sidebar: 'visible',
...
window['nsComponents'] = Object.assign(components, baseComponents);
window['nsDashboardContent'] = new Vue({
